...
const lastName = "Smyk";
console.log(`Hello me first name ${firstName} and my last name ${lastName}`);
/* Challenge #3
...
function myFunction (){
    ...
    return "myFunction return a string";
}
...
// TODO: ADD CODE HERE
const myArrowFunction = () => "I called my arrow function!";
...
console.log(stringToUpper("string to uppercase"));
/* Challenge #8
